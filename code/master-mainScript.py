...
import sys
import pickle
sys.path.insert(0,'code\segmentation_package')
...
#                 'Curvature','AverageSegmentDiameter','AveragePointDiameter']
    ...
    print("CNNSegmentedImagesList: ", CNNSegmentedImagesList)   
    print("imgNamesDoneList: ", imgNamesDoneList) 
    print("imgNameFailedList: ", imgNameFailedList) 
